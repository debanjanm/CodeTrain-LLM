...
from dataset_processor import process_dataset_load_dataset
from helper import print_trainable_parameters
from templates_processor import create_prompt_qa
...
if __name__ == "__main__":
    ...
    mapped_dataset = process_dataset_load_dataset(
        dataset_path, tokenizer, create_prompt_qa, use_create_prompt=True
    )

    # Train Model and Save Fine-Tuned Model
    train_model(model, mapped_dataset["train"], tokenizer, output_model_dir, fp16=True)
